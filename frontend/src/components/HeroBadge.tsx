...
return(
    <div className='bg-white w-36 py-[3px] border border-pink-200  rounded-md'>
    <div className="flex flex-col items-center">
    <div className="flex items-center gap-1 sm:gap-2 font-[Inter]">
   <div className="bg-[#fdebf0] w-11 border border-pink-200 h-11 flex items-center  justify-center rounded-full ">
